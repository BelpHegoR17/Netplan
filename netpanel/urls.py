"""
URL configuration for netpanel project.
...
urlpatterns = [
    ...
    # path('api/devices/',views.DeviceViewset.as_view,name="device_list_api"),
    ...
    # path('api/device/delete/<int:id>/',views.delete_device_api,name="delete_device_api"),
]
